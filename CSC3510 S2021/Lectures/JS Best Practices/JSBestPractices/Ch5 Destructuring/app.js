...
// This code section needs to be rewritten to use descructuring
//const template = (session) => {
  ...
  //)
//};
// Rewrite to desstructur
// Instead of using the session object ... destructure immediately
                  //const template = ( session) => {
//
const template = ( {session_title: title, session_presenter: presenter, session_day: day, session_start: start, session_summary: summary, session_end: end}) =>
//const title = session.session_title;
//const session_day = session.session_day;
//const session_start = session.session_start;
//const session_end = session.session_end;
//const session_presenter = session.session_presenter;
//const session_summary = session.session_summary;
// Note - don't need return statement
    `<div class='session'>
